<div class="row">
	<div class="container col-md-offset-2 col-md-col-md-8 jumbotron">
		<form:form action="/javaproject1/admin/add/product" method="POST" modelAttribute="product" class="form-horizontal" enctype="multipart/form-data">
			
			<form:hidden path="id" />
						
			<div class="form-group">
				<label class="col-md-2 control-lable" for="productname">Category
					Name</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-md-2 control-lable" for="price">Product Price</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input type="text" path="qty" id="qty" class="form-control input-sm" />
					<div class="has-error">
